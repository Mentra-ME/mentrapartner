...
export const SessionsTable: React.FC<SessionsTableProps> = ({ sessions = [] }) => {
    ...
    const filteredData = sessions.filter((session) => {
        const matchEmail = session.userEmail.toLowerCase().includes(searchEmail.toLowerCase());
        const matchCrisis =
            crisisFilter === 'all'
                ? true
                : crisisFilter === 'yes'
        ...
        return matchEmail && matchCrisis && matchDate;
    });
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <div className="flex flex-wrap gap-4 items-end justify-end">
                        <div className="flex flex-col space-y-1">
                            <label htmlFor="searchEmail" className="text-sm text-muted-foreground">
                                Student Email
                            </label>
                            <Input
                                id="searchEmail"
